--------------------------------------------------------------------------------
--
-- Voidfill Textures 256 1.1                                          2014-08-31
--
-- By Racso Rhodes
--
-- voidfill-textures-256/readme.txt
--
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
	...
	About
		...
		256x256 textures for the Minetest mod "Voidfill".
	...
	Install
		...
		For example, if you are using "HDX 256", you would move these files to
		the textures/HDX_256px directory in your Mintest installation directory.
